...
section = st.sidebar.selectbox("Select Section", ("Introduction", "Rating and Delivery Time", "High Power Product Categories", "Conversion Data Analysis", "Demand Forecast Analysis"))
...
elif section == "High Power Product Categories":
    st.header("High Power Product Categories")
    st.write(high_power_categories)

elif section == "Conversion Data Analysis":
    st.header("Conversion Data Analysis")
    st.write(conversion_data)

elif section == "Demand Forecast Analysis":
